...
class TermsPrivacyModal {
  ...
  createModals() {
    ...
    if (!document.getElementById('terms-conditions-modal')) {
      ...
      console.log('Terms modal in DOM:', !!document.getElementById('terms-conditions-modal'));
    } else {
    ...
    if (!document.getElementById('privacy-policy-modal')) {
      ...
      console.log('Privacy modal in DOM:', !!document.getElementById('privacy-policy-modal'));
    } else {
      console.log('Privacy modal already exists');
    }
    
    // Check if modals are visible in DOM
    console.log('All modals in DOM:', document.querySelectorAll('.modal').length);
  }
  ...
  async openTermsModal() {
    ...
    console.log('Modal body found:', !!body);
