...
console.log("[NLP-Training] All window functions exported:", {
  showAddModal: Boolean(window.showAddModal),
  toggleAddDropdown: Boolean(window.toggleAddDropdown),
  showAddKeywordModal: Boolean(window.showAddKeywordModal),
  closeAddModal: Boolean(window.closeAddModal),
  submitAddForm: Boolean(window.submitAddForm)
});
