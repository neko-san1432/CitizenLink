...
(function (global) {
  ...
  function analyzeText(rawInput, dictionary, options = {}) {
    ...
    if (debugModeEnabled) {
      ...
      console.log("%c🏆 FINAL RESULT", "color: #ef4444; font-weight: bold", {
        ...
        aiNeeded: Boolean(result._needsAIFallback)
      });
  ...
  function getAIStatus() {
    return {
      ready: tfReady,
      modelLoaded: Boolean(useModel),
      anchorsComputed: Boolean(anchorEmbeddings),
