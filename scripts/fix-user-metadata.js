...
async function fixUserMetadata() {
  try {
    ...
    const updatedMeta = {
      ...
      email_verified: currentMeta.email_verified !== void 0 ? currentMeta.email_verified : Boolean(user.email_confirmed_at),
      ...
      email_notifications: currentMeta.email_notifications !== void 0 ? currentMeta.email_notifications : true,
      sms_notifications: currentMeta.sms_notifications || false,
      push_notifications: currentMeta.push_notifications !== void 0 ? currentMeta.push_notifications : true,
