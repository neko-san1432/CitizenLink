...
const dataPath = path.join(__dirname, "../../DRIMS_Simulated_System/data/complaints/mockcomplaints.json");
...
-- Source: mockcomplaints.json (blind test - no scenario metadata)
-- Run this AFTER the initial seedMockcomplaints.sql
-- ============================================================================
...
const outputPath = path.join(__dirname, "../database/seeds/seedMockcomplaintsBatch2.sql");
